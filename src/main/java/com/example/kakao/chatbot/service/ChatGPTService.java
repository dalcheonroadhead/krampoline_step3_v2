...
public class ChatGPTService {
    ...
    static {
        ...
        translationMap.put("Iamsorry", "죄송하우다");
        translationMap.put("Whereareyougoing", "어드레 감수과");
        translationMap.put("Whatisyourname", "농 이름 뭐꽈");
        translationMap.put("Howareyou", "잘 지내수과");
        translationMap.put("Howoldareyou", "몇 살이우꽈");
        translationMap.put("Itisdelicious", "맛조수다");
        translationMap.put("Good", "조쿠다");
        translationMap.put("Idonotlikeit", "싫수다");
        translationMap.put("Howmuchisit", "얼마우꽈");
        translationMap.put("Pleasehelpme", "도와주게마씀");
        translationMap.put("Congratulations", "축하하우다");
        translationMap.put("Goodbye", "안녕히 계시우다");
        translationMap.put("Farewell", "안녕히 가시우다");
        translationMap.put("Ienjoyedthemeal", "맛있게 먹었수다");
        translationMap.put("Wheredoyoulive", "어드레 살우꽈");
        translationMap.put("Seeyoutomorrow", "내일 보게마씀");
        translationMap.put("Iloveyou", "사랑하우다");
        translationMap.put("Justamoment", "잠깐만 기달리우다");
        translationMap.put("Whatisthematter", "무슨 일이우꽈");
        translationMap.put("Areyouokay", "괜찮수과");
        translationMap.put("Goodmorning", "조은 아침이우다");
        translationMap.put("Sleepwell", "잘 자우다");
        translationMap.put("Wishyouluck", "행운 빌어주게마씀");
        translationMap.put("Longtimenosee", "오랜만이우다");
        translationMap.put("Pleasespeakslowly", "천천히 말해주게마씀");
        translationMap.put("Pleasesayitagain", "다시 말해주게마씀");
        translationMap.put("Idonotunderstand", "잘 모르겠수다");
        translationMap.put("Gotit", "알았수다");
        translationMap.put("Itisokay", "괜찮수다");
        translationMap.put("Howmuchisthis", "이거 얼마우꽈");
        translationMap.put("MayItakeaphoto", "사진 찍어도 됩주");
        translationMap.put("Whereistherestroom", "화장실 어드레우꽈");
        translationMap.put("Iamhungry", "배고프우다");
        translationMap.put("Iamthirsty", "목말르우다");
        translationMap.put("Haveagoodtime", "즐거운 시간 보내게마씀");
        translationMap.put("MayIsithere", "여그 앉아도 됩주");
        translationMap.put("Whattimeisit", "몇 시우꽈");
        translationMap.put("Iamlost", "길을 잃었수다");
        translationMap.put("Whatisthis", "이거 뭐우꽈");
        translationMap.put("Wheredidyoucomefrom", "어드레서 왔수과");
        translationMap.put("Whatareyoudoingnow", "이시방 뭐 햄수과");
        translationMap.put("Whatisyourphonenumber", "전화번호 뭐우꽈");
        translationMap.put("Whendowedepart", "언제 출발합주");
        translationMap.put("Seeyouagain", "다음에 또 보게마씀");
        translationMap.put("Ihavetogonow", "이시방 가야 하우다");
        translationMap.put("Ihaveastomachache", "배 아프우다");
        translationMap.put("Ifeelgood", "기분 조쿠다");
        translationMap.put("Iunderstand", "이해했수다");
        translationMap.put("Idonotknow", "모르겠수다");
        translationMap.put("Theweatherisnice", "날씨 조쿠다");
        translationMap.put("Itisraining", "비 오곡수다");
        translationMap.put("Itissnowing", "눈 오곡수다");
        translationMap.put("Itishot", "덥수다");
        translationMap.put("Itiscold", "춥수다");
        translationMap.put("Letusstart", "시작합주");
        translationMap.put("Didyousleepwell", "잠 잘 잤수과");
        translationMap.put("Howhaveyoubeen", "어덜 지냄수과");
        translationMap.put("Doyouhavetime", "시간 있수과");
        translationMap.put("Apologies", "죄송하우다");
        translationMap.put("Noproblem", "문제 없수다");
        translationMap.put("Welldone", "잘 했수다");
        translationMap.put("Goodidea", "조은 생각이우다");
        translationMap.put("Hereyouare", "여그 있수다");
        translationMap.put("Noway", "안됩주");
        translationMap.put("Itisfine", "괜찮수다");
        translationMap.put("Letusgotogether", "같이 갑주");
        translationMap.put("Congrats", "축하하우다");
        translationMap.put("Pleasesitdown", "앉으십주");
        translationMap.put("Pleasestandup", "일어나십주");
        translationMap.put("Becareful", "조심하십주");
        translationMap.put("Haveagoodday", "조은 하루 되게마씀");
        translationMap.put("Itwasenjoyable", "즐거웠수다");
        translationMap.put("Seeyounexttime", "다음에 만나게마씀");
        translationMap.put("Whatdoyouthink", "어덜 생각햄수과");
        translationMap.put("ShallIhelpyou", "도와드릴수과");
        translationMap.put("Imadeareservation", "예약했수다");
        translationMap.put("Enjoyyourmeal", "맛있게 드십주");
        translationMap.put("Pleasecomethisway", "이쪽으로 오십주");
        translationMap.put("Pleasetakeapicture", "사진 찍어주게마씀");
        translationMap.put("Haveanicetrip", "즐거운 여행 되게마씀");
        translationMap.put("Haveagoodvacation", "휴가 잘 보내게마씀");
        translationMap.put("Whatdoyourecommend", "어떤 거 추천하십주");
        translationMap.put("Coffeeplease", "커피 한 잔 주게마씀");
        translationMap.put("Billplease", "계산서 주게마씀");
        translationMap.put("Idonothavetime", "시간 없수다");
        translationMap.put("Pleasecallme", "전화해주게마씀");
        translationMap.put("Pleasewait", "기다려주게마씀");
        translationMap.put("Howlongwillittake", "얼마나 걸립주");
        translationMap.put("Iwanttoreserve", "예약하고 싶수다");
        translationMap.put("Myphonebatteryisdead", "휴대폰 배터리 없수다");
        translationMap.put("MayIchargeit", "충전해도 됩주");
        translationMap.put("Whereisthenextstation", "다음 역 어드레우꽈");
        translationMap.put("Whereisthebusstop", "버스 정류장 어드레우꽈");
        translationMap.put("Pleasecallataxi", "택시 불러주게마씀");
        translationMap.put("Letmeknowwhenwearrive", "도착하면 알려주게마씀");
        translationMap.put("Pleaseopenthedoor", "문 열어주게마씀");
        translationMap.put("Donottakepictures", "사진 찍지 마주");
        translationMap.put("Thisisanonsmokingarea", "여그는 금연구역이우다");
        translationMap.put("Firealarmisringing", "화재 경보기 울곡수다");
        translationMap.put("Whereistheemergencyexit", "비상구 어드레우꽈");
        translationMap.put("Behappy", "행복하십주");
        translationMap.put("Haveaniceweekend", "즐거운 주말 보내게마씀");
        translationMap.put("HappyNewYear", "새해 복 많이 받으게마씀");
        translationMap.put("MerryChristmas", "메리 크리스마스 하우다");
        translationMap.put("Happybirthday", "생일 축하하우다");
        translationMap.put("Letustoast", "건배합주");
        translationMap.put("Pleaselistencarefully", "잘 들으십주");
        translationMap.put("Goodluckonyourexam", "시험 잘 보게마씀");
        translationMap.put("Cheerup", "힘내십주");
        translationMap.put("Pleasecontactme", "연락해주게마씀");
        translationMap.put("Sorryforbeinglate", "늦어서 죄송하우다");
        translationMap.put("Donotworry", "걱정하지 마주");
        translationMap.put("Waterplease", "물 좀 주게마씀");
        translationMap.put("Nicetomeetyou", "반갑수다");
        translationMap.put("Whatisthere", "여그 뭐 있수과");
        translationMap.put("Pleaseshowmethephoto", "사진 보여주게마씀");
        translationMap.put("Pleasesendmeanemail", "메일 보내주게마씀");
